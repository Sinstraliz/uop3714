...
namespace PlovdivTournament.Entities.Entity
{
    public class User
    {
        ...
        public User(Guid id, string username, string password, string email, string firstName, string middleName, string lastName, string egn, string phone, string fax)
        {
            Id = id;
            Email = email;
            Password = password;
