...
namespace PlovdivTournament.Web.Manage.Models
{
    public class MasterViewModel
    {
        ...
        public bool UserIsAuthenticated { get { return MVCManage.SecurityManager.AuthenticatedUser != null; } }

        public UserInfo CurrentUser { get { return MVCManage.SecurityManager.AuthenticatedUser; } }
